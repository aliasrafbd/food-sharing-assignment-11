...
const Footer = () => {
    return (
        <div className='bg-gray-100 dark:bg-gray-900 text-black dark:text-red-500 p-4'>
            <div className='max-w-7xl mx-auto'>
                <footer className="ml-12 md:ml-0 footer text-base-content p-2 mt-0 mb-0 md:mt-28 py-8 mx-auto">
